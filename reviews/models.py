...
class Publisher(models.Model):
    ...
    email = models.EmailField(help_text='nxb-kimdong@gmail.com')
...
class Book(models.Model):
    ...
    publisher = models.ForeignKey(Publisher, on_delete=models.CASCADE)   # Create foreignkey ==> PKey(in Publisher)
...
class Contributor(models.Model):
    ...
    last_names = models.CharField(max_length=50, help_text="The contributor's last name or name")
