...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_names', models.CharField(help_text="The contributor's first name or name", max_length=50)),
                ('last_names', models.CharField(help_text="The contributor's last name or name", max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='nxb-kimdong@gmail.com', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
